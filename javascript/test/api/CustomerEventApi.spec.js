...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlockrSocialProofApi.CustomerEventApi();
  });

  describe('(package)', function() {
    describe('CustomerEventApi', function() {
      describe('event', function() {
        it('should call event successfully', function(done) {
          // TODO: uncomment, update parameter values for event call and complete the assertions
          /*

          instance.event(body, apiKey, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
