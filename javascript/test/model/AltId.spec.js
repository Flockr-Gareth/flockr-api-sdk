...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AltId', function() {
      beforeEach(function() {
        instance = new FlockrSocialProofApi.AltId();
      });

      it('should create an instance of AltId', function() {
        // TODO: update the code to test AltId
        expect(instance).to.be.a(FlockrSocialProofApi.AltId);
      });
