...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SocialProof', function() {
      beforeEach(function() {
        instance = new FlockrSocialProofApi.SocialProof();
      });

      it('should create an instance of SocialProof', function() {
        // TODO: update the code to test SocialProof
        expect(instance).to.be.a(FlockrSocialProofApi.SocialProof);
      });
