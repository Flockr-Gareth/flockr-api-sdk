# FlockrSocialProofApi.PredictiveSearchApi
...
# **predictiveSearch**
> Flockr predictiveSearch(body, apiKey, opts)
...
let apiInstance = new FlockrSocialProofApi.PredictiveSearchApi();
...
apiInstance.predictiveSearch(body, apiKey, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
